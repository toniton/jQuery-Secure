(function($){
	$.fn.secure = function(options){
        ...
        var id = $(this).attr("id");
        var current = $(this).attr("id","secure");
		...
		this.each(function() {
			...
			css.type = "text/css";
			css.innerHTML = "@font-face {font-family: 'MyLock';src:url('lock.svg') format('svg');}.secure-container{position:relative;width:"+(settings.width+settings.height+20)+"px;height:"+settings.height+";"+
							"padding:0px 20px;}.secure-input{background:#F7F7F7;border-radius:"+settings.radius+";border:1px solid lightgray;border-right-color: white;width:"+settings.width+"px;"+
							"height:"+settings.height+"px;padding:0px 5px;outline:none !important;float:left;pointer-events: none;text-align: center;}.secure-input[text]{display: none;background:#F7F7F7;border:1px solid lightgray;border-right-color: white;padding:0px 5px;outline:none !important;float:left;pointer-events: none;text-align: center;}.secure-side{background:"+color.valueOf()[settings.theme]+";border:1px solid lightgray;border-left-color: white;width:"+settings.height+"px;height:"+settings.height+"px;text-align: center;float:left;}.secure-icon{width:20px;height:20px;margin-top:"+(settings.height/6)+"px;}.secure-ico{fill: white;}.secure-panel{width:"+(settings.width+settings.height+20)+"px;padding:5px 25px;text-align: center;display:none;position: absolute;left:0px;top:"+settings.height+"px;}.secure-table{background:#F7F7F7;width:200px;border-radius: 1px;border:0.5px solid lightgray;padding:20px;}.secure-table td{text-align: center;}.secure-table td button{border-radius: 3px;margin:5px 0px;}.secure-action-button{width:70px;height:30px;margin:0px 10px;}.secure-action-button.accept{background: #2E933D;border:0.5px solid lightgray;color: white;}.secure-action-button.clear{background: #D84A38;border:0.5px solid lightgray;color: white;}.secure-button{background:lightgray;text-align:center;min-width:40px;height:40px;}.secure-show-code{}.secure-show-code a{color:green;text-decoration: none;}";
			document.body.appendChild(css);
			// console.log(this);
			if(settings.scramble==false){
				$("div#"+this.id).html('<div><div class="secure-container">'+
										'<input type="password" id="'+id+'" password class="secure-input"/><input text type="text" class="secure-input"/>'+
										...
										'</div>'+
										'</div>'+
										'<div data-secure class="secure-panel">'+
										'<table data-secure class="secure-table">'+
										'	<tr data-secure>'+
										'		<td data-secure><button data-secure class="secure-button">1</button></td>'+
										'		<td data-secure><button data-secure class="secure-button">2</button></td>'+
										'		<td data-secure><button data-secure class="secure-button">3</button></td>'+
										'	</tr>'+
										'	<tr data-secure>'+
										'		<td data-secure><button data-secure class="secure-button">4</button></td>'+
										'		<td data-secure><button data-secure class="secure-button">5</button></td>'+
										'		<td data-secure><button data-secure class="secure-button">6</button></td>'+
										'	</tr>'+
										'	<tr data-secure>'+
										'		<td data-secure><button data-secure class="secure-button">7</button></td>'+
										'		<td data-secure><button data-secure class="secure-button">8</button></td>'+
										'		<td data-secure><button data-secure class="secure-button">9</button></td>'+
										'	</tr>'+
										'	<tr data-secure>'+
										'		<td data-secure><button data-secure class="secure-action-button clear">Clear</button></td>'+
										'		<td data-secure><button data-secure class="secure-button">0</button></td>'+
						...
						var buttons = ['<button data-secure class="secure-button">0</button>',
						...
						var scrambledbuttons = shuffle(buttons);

						var scrambled = ('<tr data-secure>'+
										'		<td data-secure>'+scrambledbuttons[0]+'</td>'+
										'		<td data-secure>'+scrambledbuttons[1]+'</td>'+
										'		<td data-secure>'+scrambledbuttons[2]+'</td>'+
										'	</tr>'+
										'	<tr data-secure>'+
										'		<td data-secure>'+scrambledbuttons[3]+'</td>'+
										'		<td data-secure>'+scrambledbuttons[4]+'</td>'+
										'		<td data-secure>'+scrambledbuttons[5]+'</td>'+
										'	</tr>'+
										'	<tr data-secure>'+
										'		<td data-secure>'+scrambledbuttons[6]+'</td>'+
										'		<td data-secure>'+scrambledbuttons[7]+'</td>'+
										'		<td data-secure>'+scrambledbuttons[8]+'</td>'+
										'	</tr>'+
										'	<tr data-secure>'+
										'		<td data-secure><button data-secure class="secure-action-button clear">Clear</button></td>'+
										'		<td data-secure>'+scrambledbuttons[9]+'</td>'+
										'		<td data-secure><button data-secure class="secure-action-button accept">Accept</button></td>'+
										'	</tr>');
				...
				$('.secure-container,.secure-input,.secure-side').click(function(){
